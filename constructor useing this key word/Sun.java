...
public static int position;
	...
	public Sun (int position,String name,long series,float gravity,double diameter,char panetCode,boolean supportLife){
	    
		System.out.println("first try="+this.position);
		...
		System.out.println("Second try="+this.position);
